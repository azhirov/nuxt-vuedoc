...
export default defineComponent({
  name: "VuedocApiMethod",
  props: {
    value: {
      type: Object as PropType<MethodDescriptor>,
      required: true,
    },
  },
  computed: {
    ...
    computedClasses() {
      return {
        'vuedoc-c-api-method--deprecated': !!this.deprecated,
      }
    },
  }
})
...
<template>
  <tr
    class="vuedoc-c-api-table__row vuedoc-c-api-method"
